        ...
        <section className="bg-indigo-50 pb-52">
            <div className="pt-8 pb-8 px-4 mx-auto max-w-screen-lg lg:p-8">
                ...
                <h1 className="pb-6 text-center lg:text-lg font-bold text-gray-500">
                    ENCOUNTER FOCAL ISSUE: How Dangerous CVPD Disease in Citrus
                    Plantation
                </h1>
                <p className="font-light text-center text-gray-500 text-base">
                    This section will explain what CVPD is and its threat to
                    citrus plantations. You will also learn about the additional
                    problematic aspect of citrus plantations in Bali.
                </p>
                <h1 className="pt-12 pb-3 lg:text-lg font-bold text-gray-900">
                    Learning Objectives
                </h1>
                <div>
                    <div className="mb-3 block min-h-[1.5rem] pl-[1.5rem] bg-indigo-500 rounded-lg">
                        <div className="p-4">
                            ...
                            >
                                Explain CVPD that attack Citrus production
                            </label>
                        </div>
                    </div>
                    <div className="mb-3 block min-h-[1.5rem] pl-[1.5rem] bg-indigo-500 rounded-lg">
                        <div className="p-4">
                            ...
                            >
                                Explain the effects of CVPD in Citrus Plantation
                            </label>
                        </div>
                    </div>
                    <div className="mb-3 block min-h-[1.5rem] pl-[1.5rem] bg-indigo-500 rounded-lg">
                        <div className="p-4">
                            ...
                            >
                                Explain SWOT analysis regarding problematic
                                issue in Citrus Plantation
                            </label>
                        </div>
                    </div>
                </div>
