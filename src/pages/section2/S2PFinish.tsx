...
const S2PFinish = () => {
    ...
    const { t: ts2 } = useTranslation("section2");
    ...
    const ContentS2PFinish = [
        {
            ...
            subtitle: t("2"),
            content1: t("3"),
            content2: ts2("los2.0.5"),
            content3: ts2("los2.0.6"),
            content4: ts2("los2.0.7"),
    ...
    return (
        <section className="bg-indigo-50 pb-4">
